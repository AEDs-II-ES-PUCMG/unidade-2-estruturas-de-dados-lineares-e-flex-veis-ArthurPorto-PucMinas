...
public class App {
    ...
    static Produto localizarProdutoDescricao(String descricao) {
    ...
    public static void finalizarPedido(Pedido pedido) {
        ...
        if (pedido == null || pedido.getItensDoPedido().vazia()) {
            System.out.println("Não há pedido válido para finalizar.");
            return;
        }
    ...
    public static void filtrarPorProduto() {
        ...
        Produto produto = localizarProdutoDescricao(descricao);
        ...
        try {
            Lista<Pedido> pedidosEncontrados = pedidos.filtrar(new CondicaoFiltrarPedido(produto));

            if (pedidosEncontrados.vazia()) {
                System.out.println("Nenhum pedido contém o produto informado.");
            } else {
                System.out.println("Pedidos encontrados:");
                pedidosEncontrados.imprimir();
            }
        } catch (IllegalStateException e) {
            System.out.println("Nenhum pedido foi finalizado até o momento.");
        }
    }
